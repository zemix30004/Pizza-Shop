	...
	<body>
		...
		<h2 class="text-center mb-5">Загрузка и импорт файлов txt csv</h2>
					@csrf
					...
					<button type="submit" name="submit" class="btn btn-primary btn-block mt-4">
						...
						<ul>
							<li>Загрузите файл CSV:</li>
						</ul>
					</button>
					<br><hr>
					<div class="form-group">
						<input type="file" name="file" class="form-control" id="chooseFile" accept=".txt">
						<label class="form-control-label" for="chooseFile">Выберите TXT файл</label>
					</div>

					<button type="submit" name="submit" class="btn btn-secondary btn-block mt-4">

						<ul>
							<li>Загрузите файл TXT:</li>
						</ul>
					</button>
			</form>
<?php
...
<br><hr>
    ...
    <button type="submit" name="submit" class="btn btn-danger btn-block mt-4">
        <ul>
            <li>Вывод количества найденных слов:</li>
        </ul>
    </button>
    <br><hr>
    </form>
